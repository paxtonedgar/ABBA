...
// The AmenityFunc type is an adapter to allow the use of ordinary function as a Querier.
type AmenityFunc func(context.Context, *ent.AmenityQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f AmenityFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.AmenityQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.AmenityQuery", q)
}

// The TraverseAmenity type is an adapter to allow the use of ordinary function as Traverser.
type TraverseAmenity func(context.Context, *ent.AmenityQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseAmenity) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseAmenity) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.AmenityQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.AmenityQuery", q)
}
...
// The PropertyAmenityFunc type is an adapter to allow the use of ordinary function as a Querier.
type PropertyAmenityFunc func(context.Context, *ent.PropertyAmenityQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f PropertyAmenityFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.PropertyAmenityQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.PropertyAmenityQuery", q)
}

// The TraversePropertyAmenity type is an adapter to allow the use of ordinary function as Traverser.
type TraversePropertyAmenity func(context.Context, *ent.PropertyAmenityQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraversePropertyAmenity) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraversePropertyAmenity) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.PropertyAmenityQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.PropertyAmenityQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	switch q := q.(type) {
	case *ent.AmenityQuery:
		return &query[*ent.AmenityQuery, predicate.Amenity, amenity.OrderOption]{typ: ent.TypeAmenity, tq: q}, nil
	...
	case *ent.PropertyAmenityQuery:
		return &query[*ent.PropertyAmenityQuery, predicate.PropertyAmenity, propertyamenity.OrderOption]{typ: ent.TypePropertyAmenity, tq: q}, nil
	case *ent.RoomQuery:
