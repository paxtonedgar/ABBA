...
// HasReviewedProperties applies the HasEdge predicate on the "reviewed_properties" edge.
func HasReviewedProperties() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasReviewedPropertiesWith applies the HasEdge predicate on the "reviewed_properties" edge with a given conditions (other predicates).
func HasReviewedPropertiesWith(preds ...predicate.Property) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newReviewedPropertiesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
