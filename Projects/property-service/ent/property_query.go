...
func (_q *PropertyQuery) QueryOwner() *UserQuery {
...
func (_q *PropertyQuery) QueryReviewer() *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *PropertyQuery) QueryRooms() *RoomQuery {
...
func (_q *PropertyQuery) QueryAmenities() *AmenityQuery {
...
func (_q *PropertyQuery) QueryPropertyAmenities() *PropertyAmenityQuery {
...
func (_q *PropertyQuery) Clone() *PropertyQuery {
	...
	return &PropertyQuery{
		...
		withAmenities:         _q.withAmenities.Clone(),
...
func (_q *PropertyQuery) WithOwner(opts ...func(*UserQuery)) *PropertyQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *PropertyQuery) WithReviewer(opts ...func(*UserQuery)) *PropertyQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PropertyQuery) WithRooms(opts ...func(*RoomQuery)) *PropertyQuery {
	query := (&RoomClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PropertyQuery) WithAmenities(opts ...func(*AmenityQuery)) *PropertyQuery {
	query := (&AmenityClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withAmenities = query
	return _q
}
...
func (_q *PropertyQuery) WithPropertyAmenities(opts ...func(*PropertyAmenityQuery)) *PropertyQuery {
	query := (&PropertyAmenityClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PropertyQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Property, error) {
	...
	if query := _q.withOwner; query != nil {
		if err := _q.loadOwner(ctx, query, nodes, nil,
			func(n *Property, e *User) { n.Edges.Owner = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withReviewer; query != nil {
		if err := _q.loadReviewer(ctx, query, nodes, nil,
			func(n *Property, e *User) { n.Edges.Reviewer = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withRooms; query != nil {
		if err := _q.loadRooms(ctx, query, nodes,
			func(n *Property) { n.Edges.Rooms = []*Room{} },
			func(n *Property, e *Room) { n.Edges.Rooms = append(n.Edges.Rooms, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withAmenities; query != nil {
		if err := _q.loadAmenities(ctx, query, nodes,
			func(n *Property) { n.Edges.Amenities = []*Amenity{} },
			func(n *Property, e *Amenity) { n.Edges.Amenities = append(n.Edges.Amenities, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withPropertyAmenities; query != nil {
		if err := _q.loadPropertyAmenities(ctx, query, nodes,
			func(n *Property) { n.Edges.PropertyAmenities = []*PropertyAmenity{} },
			func(n *Property, e *PropertyAmenity) {
				n.Edges.PropertyAmenities = append(n.Edges.PropertyAmenities, e)
			}); err != nil {
			return nil, err
		}
	}
...
func (_q *PropertyQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*Property, init func(*Property), assign func(*Property, *User)) error {
...
func (_q *PropertyQuery) loadReviewer(ctx context.Context, query *UserQuery, nodes []*Property, init func(*Property), assign func(*Property, *User)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Property)
	for i := range nodes {
...
func (_q *PropertyQuery) loadRooms(ctx context.Context, query *RoomQuery, nodes []*Property, init func(*Property), assign func(*Property, *Room)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(room.FieldPropertyID)
	}
...
func (_q *PropertyQuery) loadAmenities(ctx context.Context, query *AmenityQuery, nodes []*Property, init func(*Property), assign func(*Property, *Amenity)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(property.AmenitiesTable)
		s.Join(joinT).On(s.C(amenity.FieldID), joinT.C(property.AmenitiesPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(property.AmenitiesPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(property.AmenitiesPrimaryKey[0]))
...
func (_q *PropertyQuery) loadPropertyAmenities(ctx context.Context, query *PropertyAmenityQuery, nodes []*Property, init func(*Property), assign func(*Property, *PropertyAmenity)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Property)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(propertyamenity.FieldPropertyID)
	}
	query.Where(predicate.PropertyAmenity(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(property.PropertyAmenitiesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *PropertyQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withOwner != nil {
			_spec.Node.AddColumnOnce(property.FieldOwnerID)
		}
		if _q.withReviewer != nil {
			_spec.Node.AddColumnOnce(property.FieldReviewedBy)
		}
	}
